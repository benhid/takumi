...
impl CIDFont {
  ...
  pub(crate) fn serialize(
    ...
    //
    // The spec types `/DW` as an integer, and a reader that enforces that falls back to the
    // spec default of 1000 for every glyph the entry covers. Round it, and let `/W` carry any
    // glyph whose own width no longer matches.
